...
#SBATCH --job-name=hmc_Dbase23fixfexp_deltapsf_Mbase23fix_deltapsf
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc -n 10000 --n_step 0 --data base23fixfexp_deltapsf --model base23fix_deltapsf
