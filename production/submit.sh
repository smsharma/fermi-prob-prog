...
#SBATCH --job-name=hmc_Dbase23fix_deltapsf_2_Mbase23fix_7exp_deltapsf
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc -n 10000 --n_step 0 --data base23fix_deltapsf_2 --model base23fix_7exp_deltapsf --n_exp 7 --seed 4242
