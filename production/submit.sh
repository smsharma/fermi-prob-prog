...
#SBATCH --job-name=hmcnt_Dbase23fix_deltapsf_Mbase23fix_deltapsf
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmcnt -n 10000 --n_step 10000 --data base23fix_deltapsf --model base23fix_deltapsf

# run svi: python 1_fit.py -i 0 --fit_type svi -n 50000 --n_step 10000 --data base1023_fexp --model np
# test hmc: python 1_fit.py -i 0 --fit_type testhmc --data base23fix_deltapsf --model base23fix_deltapsf --comment test
