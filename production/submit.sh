...
#SBATCH --job-name=svi_Dbase23fixfexp_deltapsf_Mbase23fix_deltapsf_2
#SBATCH --array=0-0
...
# python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc -n 10000 --n_step 0 --data base23fixfexp_deltapsf --model base23fix_deltapsf --seed 4242 --comment 2
