...
#SBATCH --job-name=hmc_Dhardsbfexp_deltapsf_Mbase23fix_deltapsf
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc -n 10000 --n_step 0 --data hardsbfexp_deltapsf --model base23fix_deltapsf --seed 42
...
# test hmc: python 1_fit.py -i 0 --fit_type testhmc --data hardsbfexp_deltapsf --model base23fix_deltapsf --comment test
