...
#SBATCH --job-name=hmc_Dbase23fixfexp_Mbase23fix
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc -n 10000 --n_step 0 --data base23fixfexp --model base23fix --seed 4242
