...
#SBATCH --job-name=hmc_Dbase23fix_Mbase23fix
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc -n 10000 --n_step 0 --data base23fix --model base23fix --seed 4242
...
# test hmc: python 1_fit.py -i 0 --fit_type testhmc --data base23fixfexp --model base23fix --comment test
