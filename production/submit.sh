...
#SBATCH --job-name=hmc_D1b_deltapsf_M1b_7exp_deltapsf
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc -n 10000 --n_step 0 --data 1b_deltapsf --model 1b_7exp_deltapsf --n_exp 7 --seed 4242
...
# test hmc: python 1_fit.py -i 0 --fit_type testhmc --data 1b_deltapsf --model 1b_7exp_deltapsf --n_exp 7 --comment test
