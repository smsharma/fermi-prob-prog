...
#SBATCH --job-name=svi_Dbase23fix_deltapsf_Mbase23fix_deltapsf_ns30000
#SBATCH --array=0-0
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type svi -n 50000 --n_step 30000 --data base23fix_deltapsf --model base23fix_deltapsf
