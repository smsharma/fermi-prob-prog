...
#SBATCH --job-name=svi_Dbase23fix_deltapsf_2_Mbase23fix_7exp_deltapsf
#SBATCH --array=0
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type svi --n_step 20000 -n 50000 --data base23fix_deltapsf_2 --model base23fix_7exp_deltapsf --n_exp 7 --seed 4242
# python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc --n_step 0     -n 10000 --data base23fix_deltapsf_2 --model base23fix_7exp_deltapsf --n_exp 7 --seed 4242
