...
#SBATCH --job-name=hmc_Dbase23fix_deltapsf_Mbase23fixnexp7_deltapsf
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc -n 10000 --n_step 0 --data base23fix_deltapsf --model base23fixnexp7_deltapsf --n_exp 7 --seed 4242
...
# test hmc: python 1_fit.py -i 0 --fit_type testhmc --data base23fix_deltapsf --model base23fixnexp7_deltapsf --n_exp 7 --comment test
