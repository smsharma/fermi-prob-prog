...
#SBATCH --job-name=hmc_Dgpsfix_s1k_Mkmaxfix_s1k
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc -n 10000 --data gpsfix_s1k --model kmaxfix_s1k

# run svi: python 1_fit.py -i 0 --fit_type svi -n 50000 --n_step 10000 --data base1023_fexp --model np
# test hmc: python 1_fit.py -i 0 --fit_type test --data gpsfix_s1k --model kmaxfix_s1k