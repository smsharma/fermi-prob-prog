...
#SBATCH --job-name=pthmc_Dpsc_deltapsf_Mbase23fix_deltapsf
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type pthmc -n 10000 --n_step 2000 --data psc_deltapsf --model base23fix_deltapsf
