...
#SBATCH --job-name=gcfull_largeSpsnfw
#SBATCH --array=0
...
python fit.py -i $SLURM_ARRAY_TASK_ID -n 50000 --fit_type svi --n_step 10000 \
    --psf delta --model gcfull --data gcfull_largeSpsnfw --label 1001
...
# test with: python fit.py -i 0 -n 50000 --fit_type svi --n_step 100 --psf delta --model gcfull --data gcfull --label 0930