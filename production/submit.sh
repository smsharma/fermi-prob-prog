...
#SBATCH --job-name=hmc_Dgceps_x5exp_deltapsf_Mgceps_7exp_deltapsf
#SBATCH --array=0-29
...
python 1_fit.py -i $SLURM_ARRAY_TASK_ID --fit_type hmc -n 10000 --n_step 0 --data gceps_x5exp_deltapsf --model gceps_7exp_deltapsf --n_exp 7 --seed 4242
