...
if __name__ == '__main__':
    ...
    run_name = 'calibration/hmc-fullprior-0Alm-delta-mapinit'
    ...
    theta_true = json.load(open(os.environ['MYSTORE'] + f"/fermi/fermi-prob-prog/outputs/truths/{truth_name}.json"))
