...
#SBATCH --job-name=svi_Dmixpib_Mbase23fix
#SBATCH --array=0-2
...
python fit.py -i $SLURM_ARRAY_TASK_ID --fit_type svi --n_step 10000 -n 50000 \
    --data mixpib --model base23fix --n_exp 7 --seed 424242 --lr 3e-4 --n_par 16 \
...
#     --data mixpib --model base23fix --n_exp 7 --seed 4224 --comment ""
