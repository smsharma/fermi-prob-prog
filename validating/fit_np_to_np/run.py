...
if __name__ == "__main__":
    ...
    run_dir = "/n/home07/yitians/fermi/fermi-prob-prog/outputs/np_np_dsk_gce"
    ...
    counts[~model.normalization_mask] = np.load(f"{run_dir}/counts_{args.i}.npy")
    ...
    svi_results = model.fit_svi(
        ...
        n_steps=10000, lr=5e-4, num_particles=8, data=counts
    )
    ...
    mcmc = model.run_nuts(
        ...
        rng_key=key, use_neutra=True, data=model.data
    )
    rng_key, key = jax.random.split(rng_key)
