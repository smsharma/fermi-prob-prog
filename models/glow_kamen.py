...
class Squeeze(nn.Module):
    ...
    For each channel, it divides the image into subsquares of shape 2 x 2 x c, then reshapes them into subsquares of 
    shape 1 x 1 x 4c. The squeezing operation transforms an s x s x c tensor into an s x s x 4c tensor """
    def __init__(self):
        super().__init__()
