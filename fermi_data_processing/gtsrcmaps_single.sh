...
gtsrcmaps $OPTS \
    ...
    outfile=$OUT_DIR/$RUN_NAME"_ultracleanveto_bestpsf_halfsky1.fits" \
    irfs=$IRFS &

punlearn gtsrcmaps
    
gtsrcmaps $OPTS \
    cmap=$DATA_DIR/ccube_ultracleanveto_bestpsf_halfsky2.fits \
    outfile=$OUT_DIR/$RUN_NAME"_ultracleanveto_bestpsf_halfsky2.fits" \
    irfs=$IRFS &
